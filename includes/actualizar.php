...
<div id="page" class="container">
    ...
    <form action="actualizar_datos.php" method="post" accept-charset="utf-8">
      <h4>Actualización de registro</h4>
      <div class="inset">
      <p>
      ...
      <p>
        ...
        <input type="date" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" placeholder="0000-00-00" value="<?php echo $fecha_nacimiento;?>" required>
      </p> 
      <p>
